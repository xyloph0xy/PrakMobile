...
import com.luluksofiyah.uts.data.ArtData
import com.luluksofiyah.uts.model.Art
...
fun ArtSpaceApp() {
    ...
    Column {
        ...
        TopicCard(data = artList[currentIndex])
        Spacer(modifier = Modifier.height(10.dp))
        ViewButton(
            onPreviousClick = {
...
@Composable
fun TopicCard(data: Art) {
    LazyRow(
        horizontalArrangement = Arrangement.spacedBy(16.dp),
        modifier = Modifier.padding(40.dp)
    ){
        items(ArtData.artList){
            data ->
            Image(
                painter = painterResource(id = data.imageResource2),
