...
import com.luluksofiyah.uas.ui.components.CLoading
import com.luluksofiyah.uas.ui.components.detail.DetailGenre
import com.luluksofiyah.uas.ui.components.detail.DetailImage
import com.luluksofiyah.uas.ui.components.detail.DetailMovieRow

@Composable
fun DetailScreen(
    movieId: Int?,
    detailViewModel: DetailVM = hiltViewModel()
) {
